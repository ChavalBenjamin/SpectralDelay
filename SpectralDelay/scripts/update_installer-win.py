...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SpectralDelay Demo Installer\n"
      else:
        line="OutputBaseFilename=SpectralDelay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SpectralDelay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SpectralDelay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SpectralDelay Demo installer\n"
     else:
       line="SetupWindowTitle=SpectralDelay installer\n"
