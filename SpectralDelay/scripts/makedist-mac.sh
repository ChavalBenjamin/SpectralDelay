...
NOTARIZE_BUNDLE_ID=com.BEnjaminChaval.SpectralDelay
NOTARIZE_BUNDLE_ID_DEMO=com.BEnjaminChaval.SpectralDelay.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/SpectralDelay.iss
#  git checkout installer/SpectralDelay.pkgproj
