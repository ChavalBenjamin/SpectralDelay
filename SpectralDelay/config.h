...
#define AUV2_ENTRY SpectralDelay_Entry
#define AUV2_ENTRY_STR "SpectralDelay_Entry"
#define AUV2_FACTORY SpectralDelay_Factory
#define AUV2_VIEW_CLASS SpectralDelay_View
#define AUV2_VIEW_CLASS_STR "SpectralDelay_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "SpectralDelay\nIPEF"
